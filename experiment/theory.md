...
where ¦È<sub>¦Ë</sub> is the CD of the protein as a function of wavelength, ¦Å<sub>i</sub> is the fraction of each secondary structure, i, and S<sub>¦Ëi</sub> is the ellipticity at each wavelength of each ith secondary structural element. In constrained fits, the sum of all the fractional weights, ¦Å<sub>i</sub>, must equal one and all of the fractional contributions must be greater than or equal to zero.
...
Advantage: This method results in relatively good estimates of ¦Á-helices and ¦Â-sheets. Different references are used for every fit, which is an advantage for obtaining the best fits of the data.
...
Advantage: CDNN analyzes data to determine helix, anti and parallel ¦Â- structure, turns and remainder and K2D determines helix, total ¦Â-structure and remainder. K2D gives a good estimate of the helical and sheet contents of both proteins and polypeptides.
